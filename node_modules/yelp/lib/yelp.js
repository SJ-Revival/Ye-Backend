...
Client.prototype.get = function(resource, params, callback) {
    if ( typeof params.category_filter === 'object') params.category_filter = params.category_filter.toString();
    if ( typeof params.location === 'object') params.location = params.location.toString();
    params.ll = params.ll.toString();
